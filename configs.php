...
$configs['from_name']				= 'Lawrence Chen';								// Your name will be used in emails
$configs['from_address']			= 'chen.lawr7@gmail.com';							// Your email address used to send emails
$configs['to_addresses']			= array('chen.lawr7@gmail.com');						// The addresse(s) where to send all the requests
/* END - Required Config */
